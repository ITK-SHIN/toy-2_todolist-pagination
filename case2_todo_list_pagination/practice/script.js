;(function () {
  ...
  const pagination = () => {
    let totalPage = Math.ceil(totalCount / limit) //총페이지 갯수
    let pageGroup = Math.ceil(currentPage / pageCount) //현재 페이지가 속한 그룹 계산
    ...
    let firstNumber = lastNumber - (pageCount - 1) //첫번쨰 숫자 구하기
